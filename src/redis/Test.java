...
public class Test {
    public static void main(String[] args) {
        ...
        Mailbox mbox1 = new Mailbox(user1, adapter);
        Mailbox mbox2 = new Mailbox(user2, adapter);
        Mailbox mbox3 = new Mailbox(user3, adapter);
        ...
        try {
            ...
            Thread.sleep(200);
            mbox2.send(user1, "subject filter", "body 2");
            Thread.sleep(200);
